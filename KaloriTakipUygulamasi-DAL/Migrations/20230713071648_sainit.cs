...
{
    public partial class sainit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryPicture = table.Column<string>(name: "Category Picture", type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", 32, new DateTime(2023, 7, 13, 10, 16, 46, 829, DateTimeKind.Local).AddTicks(8626), "İstanbul", "Türkiye", new DateTime(2023, 7, 13, 10, 16, 46, 829, DateTimeKind.Local).AddTicks(8629), "sametarsl@gmail.com", "Samet", true, "Arslan", null, "nG9E5OVTK0GbLkh38JIzZubiS1A=", new DateTime(2023, 7, 13, 10, 16, 46, 829, DateTimeKind.Local).AddTicks(8631) });
